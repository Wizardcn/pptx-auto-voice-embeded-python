...
def format_scripts_file(filepath):
    speakerEnum = {
        'คริส': 27,
        'ครูดีดี๊': 17,
        'คอรีย์': 57,
    ...
    scripts['audio_url'] = [botnoi_voice(sentence, speakerEnum[speaker]) for sentence, speaker in zip(
...
if __name__ == "__main__":
    ...
    scripts_df = format_scripts_file(excel_file)
